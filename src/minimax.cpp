...
Best_Move *AlphaBetaMax (ChessBoard board, int alpha, int beta, int depth, Move move)
{
	...
	else
	{
			 ...
			 it != Moves.end(); ++it)
		{
			...
			Best_Move *New_Move = AlphaBetaMin (board_c, depth - 1, Curr_Move);
...
Best_Move *AlphaBetaMin (ChessBoard board, int depth, Move move)
{
	if (depth == 0)
	{
		Best_Move *Last = new Best_Move;
